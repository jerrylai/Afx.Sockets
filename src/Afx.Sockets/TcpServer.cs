...
namespace Afx.Sockets
{
    ...
    public abstract class TcpServer : ITcpServer
    {
        ...
        private void OnAcceptEvent(IAsyncTcpSocket client)
        {
        ...
        private void OnClientReceiveEvent(IAsyncTcpSocket client, List<byte[]> data)
        {
        ...
        private void OnClientErrorEvent(IAsyncTcpSocket client, Exception ex)
        {
        ...
        /// <returns></returns>
        protected abstract AsyncTcpSocket Accept(Socket client, int sendBufferSize, int receiveBufferSize);
